      ...
      <div className="aboutMe">
        ...
        <div className="contents">
          ...
          <div className="textBox">
            ...
            <p>
				안녕하세요. 끊임없이 성장하고 있는 웹퍼블리셔 이현정입니다. 이전에는 건강기능식품 회사에서 약 5년간 학술 및 개발 업무를 담당하였습니다. 이 경험을 바탕으로 문제해결능력을 쌓을 수 있었고 웹퍼블리셔로서 새로운 길을 걷게 되었습니다. 코드를 활용하여 무언가를 만들어 낼 때 매우 큰 즐거움을 느낍니다. 웹표준과 크로스브라우징에 대한 이해가 있으며 사용자 경험을 최우선으로 하는 웹퍼블리셔가 되고자 합니다. 새로운 것을 배우는 데 주저하지 않으며 책임감있게 프로젝트를 수행할 수 있습니다.
            </p>
          </div>
