	  ...
	  return (
		<>
		  <SitePage
			...
			projectComment="사이트 내에서 여러가지 프로젝트를 한 눈에 바로 볼 수 있도록 iframe을 활용하였으며, React Router를 활용하여 페이지 이동을 편리하게 작업했습니다. UI 라이브러리를 사용하지 않고 스타일 컴포넌트를 활용하여 제작하였고 Components와 Props를 활용하여 코드의 가독성을 높이고 유지/보수에 편리하게 만들었습니다. 또한, useState와 useEffect와 같은 Hook을 활용하여 프로젝트마다 메뉴 색상을 변경함으로써 동적인 페이지를 구현했습니다."
			bgImg={bgPortfolio}
		  />
		</>
	  );
